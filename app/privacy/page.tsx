...
function ThaiPolicy() {
  return (
    <article id="th" className="scroll-mt-6">
      ...
      <Section heading="2. แอปนี้ไม่มีระบบสมาชิก">
        <p>
          แอปไม่มีการสมัครสมาชิก ไม่มีการเข้าสู่ระบบ และไม่มีการสร้างบัญชีผู้ใช้
      ...
      <Section heading="7. สิทธิของคุณ">
        <p>
          ...
          เนื่องจากแอปไม่มีระบบสมาชิก ข้อมูลเกือบทั้งหมดอยู่ในเครื่องของคุณเอง
